...
// Main Menu
handleClick($('.walk-block'), () => {
	document.getElementById("character").src="walk.gif"
});

handleClick($('.coffee-block'), () => {
	document.getElementById("character").src="coffee.gif"
});

handleClick($('.eat-block'), () => {
	document.getElementById("character").src="eat.gif"
});

handleClick($('.dance-block'), () => {
	document.getElementById("character").src="dance.gif"
});
...
function incrementCubeCount(inc) {
    document.getElementById("character").src="jump.gif"
    setTimeout(function() {
        document.getElementById("character").src="walk.gif"
      }, 1000);
    console.log("smashed")
